...
public class ProducerIdsRecordJsonConverter {
    public static ProducerIdsRecord read(JsonNode _node, short _version) {
        ...
        if (_nextProducerIdNode == null) {
            throw new RuntimeException("ProducerIdsRecord: unable to locate field 'nextProducerId', which is mandatory in version " + _version);
        } else {
            _object.nextProducerId = MessageUtil.jsonNodeToLong(_nextProducerIdNode, "ProducerIdsRecord");
        }
        return _object;
    }
