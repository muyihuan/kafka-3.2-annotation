...
// 领导者辞职
/**
 *这个状态代表了一个领导者，因为它正在关闭或者因为它遇到了某种软故障而将自己隔离起来。在这个州，我们不接受写信，也不允许在这个时代投票给任何其他候选人。
 *
 *辞职的领导人可以通过向所有选民发送“EndQuorumEpoch”请求来启动新的选举。此状态跟踪此请求的传递，以防止不必要的重试。
 *
 *选民将一直处于“辞职”状态，直到我们了解到另一次选举，或者我们自己的选举超时到期，我们成为候选人。
 */
